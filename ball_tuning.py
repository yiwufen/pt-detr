...
trainer = Trainer(max_epochs=600, max_steps=600, gradient_clip_val=0.1)
trainer.fit(model)
...
# model.model.push_to_hub("yiyiyiwufeng/detr-finetuned-balloon-v2")
# processor.push_to_hub("yiyiyiwufeng/detr-finetuned-balloon-v2")
