...
checkpoint_path = "lightning_logs/fine-tuning/checkpoints/epoch=149-step=300.ckpt"
...
image.save('balloon_eval_example.jpg')
...
plt.savefig('balloon_eval_datection.jpg')
